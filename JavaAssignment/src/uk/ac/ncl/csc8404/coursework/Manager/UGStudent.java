...
/**
 * The UGStudent class is a student specific class that caters
 * to Under Graduate Students
 */
class UGStudent extends StudentFactory {
    ...
    /**
     * This is the constructor for the UGStudent class. It takes all
     ...
     */
    public UGStudent(Name n, Date DOB, String type){
        super(n,DOB,type);
    }
